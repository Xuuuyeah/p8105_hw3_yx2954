...
### Geom_hex
```{r hex_p, fig.path='data/plots/', fig.ext='png'}
...
### Ridge plot
```{r ridge_p, fig.path='data/plots/', fig.ext='png'}
...
```{r}
Jan_20 = read_csv("data/citibike/Jan 2020 Citi.csv.zip")
Jan_24 = read_csv("data/citibike/Jan 2024 Citi.csv.zip")
